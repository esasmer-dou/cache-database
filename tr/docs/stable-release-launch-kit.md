...
`v0.3.0` için seçilen resmi dağıtım kanalı GitHub Release asset'idir:
...
CacheDB `v0.3.0`, mevcut SQL tabanlı uygulamaları kontrollü biçimde CacheDB'ye
...
- Release note `docs/releases/v0.3.0.md` altında var.
...
- `Production GA Release Readiness`, `v0.3.0` için yeşil.
- GitHub Release prerelease olarak işaretli değil.
- GitHub Release asset'i `cache-database-0.3.0-github-release.zip` olarak eklendi.
