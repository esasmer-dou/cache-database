...
| Aktif veri setini çok pod'lu ortamda periyodik olarak nasıl yeniler ve temizlerim? | [Periyodik Warm ve Aktif Veri Seti Uzlaştırması](docs/periodik-warm.md) |
