...
| Stable release mi, provider bazlı beta mı? | [Production GA Criteria](../PRODUCTION_GA_CRITERIA.md) ve [Stable Release Launch Kit](docs/stable-release-launch-kit.md) |
